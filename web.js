document.addEventListener('DOMContentLoaded', () => {
    ...
    if (gifImage) {
        gifImage.onerror = function () {
            ...
            fallbackDiv.className = 'gif-image placeholder';
    ...
    audio.addEventListener('error', () => {
        alert('Файл music.mp3 не найден. Положите его в папку с main.py');
    });
    ...
    function draw() {
        ...
        for (let i = 0; i < bufferLength; i += 2) {
            ...
            const x2 = centerX + Math.cos(angle) * (15 + length);
            const y2 = centerY + Math.sin(angle) * (15 + length);
    ...
    playPauseBtn.addEventListener('click', async () => {
        ...
        if (isPlaying) {
            ...
            try {
                ...
                alert('Не удалось воспроизвести. Проверьте файл music.mp3');
            }
        }
        isPlaying = !isPlaying;
    });
